...
/**
 * Class which abstracts HTTP status codes
 *
 * PHP version 7.0
 *
 * @category   CodeCollab
...
{
    /**
     * @var int Constants of possible status codes
     */
    const CONTINUE = 100;
    ...
    /**
     * @var array List of the default textual representation of possible status codes
     */
    private $statusTexts = [
        100 => 'Continue',
